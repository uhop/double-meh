...
- 1.2.0 _Streamed bodies over the `sw` transport, a malformed SSE `retry:` no longer storms reconnects, and `{transport: 'sw'}` resolves relative URLs against the page._
