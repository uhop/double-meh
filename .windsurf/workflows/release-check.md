---
description: Pre-release verification checklist for double-meh
---
...
9. Check that the copyright year in `LICENSE` includes the current year (e.g., update `2025` → `2025-2026`).
