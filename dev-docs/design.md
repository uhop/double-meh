...
- **Backends behind one storage interface** (`retrieve/store/remove/clear/keys`), chosen per platform;
  the TTL / lazy-expiry / revalidation / invalidation / sweep logic above is backend-agnostic.
